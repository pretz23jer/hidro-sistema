...
|
*/
$config['base_url'] = 'http://localhost/sis-hidro';
...
$config['sess_expiration'] = 1020;
$config['sess_save_path'] = NULL;
$config['sess_match_ip'] = FALSE;
$config['sess_time_to_update'] = 25;
...
|
*/
$config['time_reference'] = 'date_default_timezone_set("America/Guatemala")';
